...
def test_code_body_messages(rules, nesting_depth, lines):
    '''
...
@pytest.mark.parametrize('max_num_arguments, passes', [
    ...
    (7, False),
    (1, False)])
def test_max_dummy_args(rules, max_num_arguments, passes):
